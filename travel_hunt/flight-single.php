...
<html lang="en">
<head>
<title>Travel Hunt App A Mobile App Flat Bootstrap Responsive Website Template | Flight-Single :: w3layouts</title>
...
<!-- banner -->
   <div class="details-grid flight">
		...
		<div class="w3agile banner-bottom">
			   <ul>
				    <li class="active"><a href="flight.html" class="hvr-radial-out"><i class="fa fa-plane" aria-hidden="true"></i></a><h6>Flight</h6></li>
	 ...
	 <thead>
		   ...
		   <tbody>
		     <tr>
			    ...
			    <td class="wthree"><i class="fa fa-plane" aria-hidden="true"></i> Flight 1</td>
 				<td class="wthree"><i class="fa fa-clock-o"></i> 21:30</td>
				<td class="af">
					<img src="images/a-f.png" alt=""></td>
				<td class="wthree">23:25</td>
				<td class="price"> <span>$8,750</span> $10,850
						<a href="#" data-toggle="modal" data-target="#myModalbook" class="seat-button">Book Now</a>
				</td>

			 </tr>
			 <tr>
			    <th class="t-one" scope="row">2</th>
			    <td class="wthree"><i class="fa fa-plane" aria-hidden="true"></i> Flight 2</td>
 				<td class="wthree"><i class="fa fa-clock-o"></i> 21:30</td>
				<td class="af">
					<img src="images/a-f.png" alt=""></td>
				<td class="wthree" >23:25</td>
			 ...
			 <tr>
			    ...
			    <td class="wthree"><i class="fa fa-plane" aria-hidden="true"></i> Flight 3</td>
 				<td class="wthree"><i class="fa fa-clock-o"></i> 21:30</td>
				<td class="af">
					<img src="images/a-f.png" alt=""></td>
				<td class="wthree">23:25</td>
			  ...
			  <tr>
			    ...
			    <td class="wthree"><i class="fa fa-plane" aria-hidden="true"></i> Flight 4</td>
 				<td class="wthree"><i class="fa fa-clock-o"></i> 21:30</td>
				<td class="af">
					<img src="images/a-f.png" alt=""></td>
				<td class="wthree">23:25</td>
			  ...
			  <tr>
			    ...
			    <td class="wthree"><i class="fa fa-plane" aria-hidden="true"></i> Flight 5</td>
 				<td class="wthree"><i class="fa fa-clock-o"></i> 21:30</td>
				<td class="af">
					<img src="images/a-f.png" alt=""></td>
				<td class="wthree">23:25</td>
