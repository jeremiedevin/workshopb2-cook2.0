...
<html lang="en">
<head>
<title>Travel Hunt App A Mobile App Flat Bootstrap Responsive Website Template | Hotel :: w3layouts</title>
   ...
   <div class="details-grid ht">
	...
	<!--contact -->
            <div class="w3agile contact">
			       <h3 class="w3ls-title2">Online Hotels Booking with Zero Booking Fees</h3>
			       <div class="book-a-ticket">
							<div class=" bann-info">
								<form action="hotel-single.html" method="post">
									<div class="section_dest">
											...
											<div class="bnr-right">
												<label class="inputLabel">Check out <span class="opt">&nbsp;(Optional)</span></label>
