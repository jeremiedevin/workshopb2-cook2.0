...
<html lang="en">
<head>
<title>Travel Hunt App A Mobile App Flat Bootstrap Responsive Website Template | Flight :: w3layouts</title>
   ...
   <div class="details-grid flight">
	...
	<!--contact -->
            <div class="w3agile contact">
			       <h3 class="w3ls-title2">Online Flight Tickets Booking with Zero Booking Fees</h3>
			       <div class="book-a-ticket">


							<div class=" bann-info">
								<form action="flight-single.html" method="post">
									<div class="ban-top">
										<div class="bnr-left">
			...
			<div class="bnr-right">
				<label class="inputLabel">Return<span class="opt">&nbsp;(Optional)</span></label>
			...
			<!---/End-date-piker---->
						   ...
						   <label class="inputLabel">Class</label>
																			  <select>
