...
<html lang="en">
<head>
<title>Travel Hunt App A Mobile App Flat Bootstrap Responsive Website Template | Train:: w3layouts</title>
   ...
   <div class="details-grid tr">
		...
		<div class="w3agile banner-bottom">
			    <ul>
					...
					<li class="active"><a href="train.html" class="hvr-radial-out"><i class="fa fa-train" aria-hidden="true"></i></a><h6>Train</h6></li>
	...
	<!--bus -->
            <div class="w3agile contact">
			       <h3 class="w3ls-title2">Online Train Tickets Booking with Zero Booking Fees</h3>
			       <div class="book-a-ticket">
							<div class=" bann-info">
								<form action="train-single.html" method="post">
									<div class="ban-top">
										<div class="bnr-left">
									...
									<div class="search">
									     <input type="submit" onclick="bus-single.html" value="Search">
